...
const babel = {
    ...
    options: {
        ...
        plugins: [ '@babel/plugin-transform-regenerator', '@babel/plugin-transform-async-to-generator', '@babel/plugin-proposal-optional-chaining', '@babel/plugin-proposal-nullish-coalescing-operator', '@babel/plugin-transform-arrow-functions', "@babel/plugin-transform-classes", '@babel/plugin-transform-block-scoping', '@babel/plugin-transform-parameters', '@babel/plugin-transform-destructuring', 'babel-plugin-transform-es2015-shorthand-properties', '@babel/plugin-transform-template-literals' ]
    }
};
